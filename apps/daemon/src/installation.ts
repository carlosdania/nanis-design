...
// Locations:
//
//   packaged (mac):    ~/Library/Application Support/Nanis Design Prerelease/installation.json
//   packaged (win):    %APPDATA%/Nanis Design Prerelease/installation.json
//   packaged (linux):  $XDG_CONFIG_HOME/Nanis Design Prerelease/installation.json
