...
<html lang="en">
  <head>
    ...
    <title>${connectorLabelHtml} connected · Nanis Design</title>
    <style>
      :root {
        --bg: #faf9f7;
        --bg-panel: #ffffff;
  ...
  <body>
    <main aria-labelledby="callback-title">
      <div class="chrome" aria-label="Nanis Design">
        <span class="brand-mark" aria-hidden="true">OD</span>
        <span class="brand-title">Nanis Design</span>
      </div>
      <section class="content">
        ...
        <div>
          ...
          <p>Your connector is ready to use in Nanis Design.</p>
        </div>
    ...
    <script>
      (() => {
        ...
        function showManualCloseHint() {
          ...
          hint.textContent = 'Your browser blocked automatic closing. You can close this tab and return to Nanis Design.';
        }
        ...
        try {
          if (hasLiveOpener()) {
            ...
            hint.textContent = 'You can close this tab and return to Nanis Design.';
          }
        } catch {
          hint.textContent = 'You can close this tab and return to Nanis Design.';
        }
