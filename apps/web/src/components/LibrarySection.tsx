...
// zero-config — it connects automatically whenever Nanis Design is running
      ...
      <header className="entry-section__head">
        ...
        <div className={styles.clipperHint}>
          ...
          >
            ...
            Get the Nanis Design Web Clipper
          </a>
        </div>
      </header>
      ...
      {loading && assets.length === 0 ? (
        ...
        <div className={styles.empty}>
          ...
          <p className={styles.emptyHint}>
            Clip from any page with the Nanis Design Web Clipper, run{' '}
