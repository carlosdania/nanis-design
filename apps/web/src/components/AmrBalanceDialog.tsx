...
interface Props {
  ...
  /** Nanis Design Cloud profile from the blocking snapshot; picks the console origin. */
  profile: string | null;
...
// HARD pre-run blocker for Nanis Design Cloud tasks: the run cannot possibly
...
//
//   signed_out — Nanis Design Cloud selected but no account session. The CTA
...
export function AmrBalanceDialog({
  ...
  const openWallet = () => {
    ...
    // Same attribution handshake as the other Nanis Design Cloud handoffs
